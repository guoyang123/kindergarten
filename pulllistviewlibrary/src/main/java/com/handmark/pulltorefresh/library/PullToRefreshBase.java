...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private float pro;
	public PullToRefreshBase(Context context,float pro) {
		super(context);
		this.pro=pro;
		init(context, null);
	}
	...
	protected void handleStyledAttributes(TypedArray a,float pro) {
	}
	...
	protected final void setHeaderScroll(int value) {
		...
		if (mLayoutVisibilityChangesEnabled) {
			if (value < 0) {
				Log.e("mLayoutVisibilityChangesEnabled", "1");
				
				mHeaderLayout.setVisibility(View.VISIBLE);
			} else if (value > 0) {
				Log.e("mLayoutVisibilityChangesEnabled", "2");
				mFooterLayout.setVisibility(View.VISIBLE);
			} else {
				Log.e("mLayoutVisibilityChangesEnabled", "3");
		...
		switch (getPullToRefreshScrollDirection()) {
			case VERTICAL:
				Log.e("getPullToRefreshScrollDirection", "getPullToRefreshScrollDirection");
				scrollTo(0, value);
				break;
			case HORIZONTAL:
				scrollTo(value, 0);
