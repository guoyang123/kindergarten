...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public PullToRefreshAdapterViewBase(Context context,float pro) {
		super(context,pro);
	...
	public void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		if (null != mOnFirstItemVisibleListener) {
			mFirstItemVisible = (totalItemCount > 0) && firstVisibleItem == 0;
		}
	...
	public void onScrollStateChanged(final AbsListView view, final int state) {
		...
		if (state == OnScrollListener.SCROLL_STATE_IDLE && mFirstItemVisible) {
