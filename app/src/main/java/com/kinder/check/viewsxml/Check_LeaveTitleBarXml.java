...
public class Check_LeaveTitleBarXml extends MyRelativeLayout {
	...
	public Check_LeaveTitleBarXml(Context context, float pro, float screenW,
			float screenH) 
	{
