...
import com.kinder.parent.ParentDetailActivity_VC;
...
public  abstract class MyCollectActivity_BC extends Kind_BaseActivity {

	protected MyCollectMainViewXmlView mainView;
	protected Article_DataSource dataSource;
	
	
	
	protected void interface_getCollects_byNetWork(String from,String operationtype)
	{
		KinderNetWork.interface_getCollects_byNetWork(this, getEventMessage(), from, String.valueOf(Kinder_DataSource.NUM), operationtype);
	}
