...
public class Parent_TitleBarXml extends MyRelativeLayout {
	...
	public Parent_TitleBarXml(Context context, float pro, float screenW,
			float screenH) 
	{
