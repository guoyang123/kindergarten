...
public class ParentSearch_TitleBarXml extends MyRelativeLayout {
	...
	public ParentSearch_TitleBarXml(Context context, float pro, float screenW,
			float screenH) 
	{
